...
const Modal = ({
  ...
  return React__default['default'].createElement(React__default['default'].Fragment, null, React__default['default'].createElement(GlobalStyles, null), (open || active) && React__default['default'].createElement(Portal, {
    parent: parent,
    className: parentClass
  }, React__default['default'].createElement(Backdrop, {
    ref: backdrop,
    className: active && open ? 'active' : ''
  }, React__default['default'].createElement(ModalContainer, {
